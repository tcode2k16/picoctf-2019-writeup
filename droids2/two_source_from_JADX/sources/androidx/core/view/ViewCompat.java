...
public class ViewCompat {
    ...
    public static void setPaddingRelative(@NonNull View view, @C0001Px int start, @C0001Px int top, @C0001Px int end, @C0001Px int bottom) {
        if (VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo13to = 1.0d) float value) {
        view.setAlpha(value);
    }
