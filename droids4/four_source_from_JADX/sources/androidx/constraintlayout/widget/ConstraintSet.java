...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintLeft_creator, 75);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintTop_creator, 75);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintRight_creator, 75);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintBottom_creator, 75);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintBaseline_creator, 75);
        ...
        mapToConstant.append(C0103R.styleable.ConstraintSet_android_rotation, 60);
        ...
        mapToConstant.append(C0103R.styleable.ConstraintSet_android_translationX, 51);
        mapToConstant.append(C0103R.styleable.ConstraintSet_android_translationY, 52);
        mapToConstant.append(C0103R.styleable.ConstraintSet_android_translationZ, 53);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintWidth_default, 54);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintHeight_default, 55);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintWidth_max, 56);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintHeight_max, 57);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintWidth_min, 58);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintHeight_min, 59);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintCircle, 61);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintCircleRadius, 62);
        ...
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0103R.styleable.ConstraintSet_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0103R.styleable.ConstraintSet_chainUseRtl, 71);
        mapToConstant.append(C0103R.styleable.ConstraintSet_barrierDirection, 72);
        mapToConstant.append(C0103R.styleable.ConstraintSet_constraint_referenced_ids, 73);
        mapToConstant.append(C0103R.styleable.ConstraintSet_barrierAllowsGoneWidgets, 74);
    }
